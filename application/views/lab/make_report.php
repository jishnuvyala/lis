...
<script>
    $(document).ready(function() {
        $('#upload_file').submit(function(e) {
            ...
            if(confirm("Are You sure?.This will update the status are certified"))
            {


                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url().'report/upload_file';?>",
                    data: data,
                    ...
                    success: function (response) {
                        ...
                        if (data.status === true) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo base_url().'report/update_status';?>",
                                datatype: "json",
                                data: {
                                ...
                                success: function (response) {
                                    ...
                                    if (data.status === true) {
                                        ...
                                        Lobibox.notify("success",
                                            {
                                                msg: "Report is uploaded and status changed to certified"
                                            });
                                        $("#submit").hide();
                                        $("#userfile").hide();
                                    }
