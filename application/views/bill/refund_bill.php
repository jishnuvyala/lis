                     ...
                     <div class="panel panel-default ">
                         <div class="panel-heading">
                             <div class="panel-body">
                                 ...
                                 <div class="col-md-3" id=""> <label>Name : </label><label id="name" class=" label label-info"></label></div>
                                 <div class="col-md-3"> <label>Age : </label><label id="age" class=" label label-info"></label></div>
                                 <div class="col-md-3"> <label>Phone No : </label><label id="phone" class=" label label-info"></label></div>
                                 ...
                                 <div class="table-responsive">
                                     <table class="table table-hover">
                                         ...
                                         <tr class="">
                                             ...
                                             <td> <div class="form-group "> <select id="service" name="service" class="form-control" required>
                                             ...
                                             <td></td>
                                             <td></td>
                                             <td><div class="form-group"><input  class="form-control center" type="number" style="width:50px;" name="qnty" id="qnty" value="1"/> </div></td>
                                             <td><div class="form-group"><input  class="form-control center" type="text" style="width:50px;" name="price" id="price" disabled/> </div></td>
                                         </tr>

                                         </tbody>
                                     </table>
                                     <button type="button" class='delete btn btn-info btn-sm'><i class=" fa fa-minus-circle "></i>Delete </button>
                                     <button type="button" class='addmore btn btn-info btn-sm'><i class=" fa fa-plus-circle "></i>Add Item</button>
                                 </div>
                             </div>
                         </div>
                             ...
                             <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <table class="table table-hover" id="bill">
                                         ...
                                         <tbody>
                                         <tr>
                                         <td><input class="form-control" type="number" style="width:100px;" name="billamt" id="billamt" disabled/></td>
                                             <td><input class="form-control" type="number" style="width:100px;" name="discnt" id="discnt" pattern="[0-9.]+"/></td>
                                             <td><input class="form-control" type="number" style="width:100px;" name="totalamt" id="totalamt" disabled/></td>
                                             <td><input class="form-control" type="text" style="width:100px;" name="billamt" id="paidamt" pattern="[0-9.]+" required/></td>
                                         </tr>
                                         </tbody>
                                     </table>
                                 </div>
    ...
    $(document).ready(function()
    {
       ...
       $("#discnt").change(function(){
        ...
        $("#billsubmit").submit(function(e){
            ...
            if(servicecount==0)
            {
                alert("you have to select atleast one service to save the bill");

            }
            else {

                confirm("This will save the bill and further editing is not possible.Are you sure?");
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status = true) {
                            Lobibox.notify("success",
                                {
                                    msg: "Bill is created.Bill No is : " +response.billid
                                });
                            $("#billsavebutton").hide();
