        ...
        <div class="container-fluid">
             <div class="row pad-botm">
                 <div class="col-md-12 col-sm-12 col-xs-  text-center">
                     <h4 class="header-line">Refund Bill Browser</h4>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body panel-default">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input id="frmdate" name="frmdate" type="date" placeholder="From Date"  class="form-control input-sm" value="<?php echo date('Y-m-d'); ?>" data-toggle="tooltip" data-placement="top"
                                           title="Select Ordered date from" required >
                                </div>
                                <label class="col-md-1 control-label">To date</label>
                                <div class="col-md-2">
                                    <input id="todate" name="todate" type="date" placeholder="To dateDate" class="form-control input-sm" value="<?php echo date('Y-m-d'); ?>" data-toggle="tooltip" data-placement="top"
                                           title="Select Ordered date To" required>
                                </div>
                                <label class="col-md-1 control-label">Bill No</label>
                                <div class="col-md-2">
                                    <input id="billno" name="billno" type="text" placeholder="Billno" class="form-control input-sm" data-placement="top"
...
<script>
  $(document).ready(function() {
      ...
      $("#search").submit(function (e) {
          ...
          $.ajax({
              type: "POST",
              url: "<?php echo base_url().'refundbill_browser/search'?>",
              data: datastring,
              datatype: "html",
      ...
      $(document).on('click', '#print' , function() {
          ...
          window.open("<?php echo base_url().'bill_printout/refund_view/'?>"+billid);
