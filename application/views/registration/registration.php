                ...
                success: function (response) {
                    ...
                    if (response.status === true) {
                        ...
                        Lobibox.notify("success",
                            {
                                msg: "Registration Sucessful.Lab Number is "+response.id
                            });
                    ...
                    <div class="panel-body">
                        ...
                        <form id="register" class="form-horizontal">
                            <fieldset>
                                ...
                                <!-- Form Name -->
                                <legend>Register a new patient</legend>
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="lname" name="lname" type="text" placeholder="Last Name" name="lname"
                                               class="form-control input-md" required>
                                    </div>
                                </div>
                                <div class="form-group required">
                                    ...
                                    <div class="col-md-3">
                                        <select id="gender" name="gender" class="form-control" required>
                                            <?php foreach ($gender as $row) { ?>
                                                <option
                                                    value="<?php echo $row->id; ?>"><?php echo $row->gender; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-md-3">
                                        <select id="district" name="district" class="form-control">
                                            <?php foreach ($district as $row) { ?>
                                                <option
                                                    value="<?php echo $row->district_id; ?>"><?php echo $row->district; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <!-- Button (Double) -->
                                <div class="form-group">
                                    <label class="col-md-2 control-label mandatory" for="textinput">Mobile
                                        Number</label>
                                    ...
                                    <div class="col-md-3">
                                        <input id="email" name="email" type="email" placeholder="Email" name="email"
                                ...
                                <div class="form-group">
                                    ...
                                    <div id='button' class="col-md-8">
                                        <button id="registerbutton" name="register" class="btn btn-success"
                                                type="submit">Save
                                        </button>
                                        <button id="resetbutton" name="clear" class="btn btn-danger"
                                                onClick="history.go(0)">Clear
                                        </button>
