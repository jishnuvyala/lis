...
<script type="text/javascript">
    ...
    function newPopup(url) {
        popupWindow = window.open(
            url, 'popUpWindow', 'height=600,width=700,left=400,top=10,resizable=0,scrollbars=no,toolbar=no,menubar=no,location=no,directories=no,status=yes')
    }
    </script>
        ...
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12 col-sm-12 col-xs-12 center-block text-center">
                    <h6 class="header-line">user Master</h6>
                    ...
                    <div class="panel-body panel-default text-center">
                        <form id="search">
                            <div class="form-group">
                                <div class="col-md-3">
                                    <input id="name" name="name" type="text" placeholder="Name" class="form-control input-md" data-toggle="tooltip" data-placement="top"
                                           title="Enter the name of user to search " >
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-2">
                                    <a class="btn btn-success btn-sm" href="javascript:newPopup('<?php echo base_url()?>user_master/add_new_view')" >Add new</a>
                                </div>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#search").submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url().'user_master/search'?>",
                data: datastring,
                datatype: "html",
        ...
        $(document).on('click', '#modify', function () {
            ...
            var url="<?php echo base_url().'user_master/update_view/';?>"+orderid;
