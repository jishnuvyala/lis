...
<div class="col-md-6">
    <div class="panel panel-primary">
        <div class="panel-heading">Modify Specimen details</div>
        <div class="panel-body">
            ...
            <form accept-charset="UTF-8"  class="simple_form new_user_basic"  id="add_specimen" ><div style="display:none">
                ...
                <div class="form-group email required user_basic_email"><label class="email required control-label" for="user_basic_email"><abbr title="required">*</abbr> Specimen Name</label><input class="string email required form-control" id="user_basic_email" name="specimen_name" placeholder="Enter specimen name" type="text" value="<?php echo $row->name; ?>"required/>
...
<script>
    $(document).ready(function() {
            ...
            $("#add_specimen").submit(function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url().'specimen_master/update'?>",
                    data: datastring,
                    datatype: "json",
                    success: function (response) {
                        ...
                        else
                        {
                            Lobibox.notify("warning",
                                {
                                    msg: "Name already given for another specimen"
                                });
                        }
