        ...
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                    <h6 class="header-line">Container Master</h6>
                    ...
                    <div class="panel-body panel-default">
                        <form id="search">
                            <div class="form-group">
                                <div class="col-md-3">
                                    <input id="name" name="name" type="text" placeholder="Container Name" class="form-control input-md" data-toggle="tooltip" data-placement="top"
                                           title="Enter the Conatiner name to search " >
                                </div>
                                ...
                                <div class="col-md-2">
                                    <a class="btn btn-success btn-sm" href="javascript:newPopup('<?php echo base_url()?>container_master/add_new_view')" >Add new</a>
                                </div>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#search").submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url().'container_master/search'?>",
                data: datastring,
                datatype: "html",
        ...
        $(document).on('click', '#modify', function () {
            ...
            var url="<?php echo base_url().'container_master/update_view/';?>"+orderid;
