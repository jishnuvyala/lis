...
class Refundbill_browser extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('refundbillbrowser_model');

    }
    public function index()
    {
        $this->load->view('bill/refundbillbrowser');
    ...
    public function search()
    {
       ...
       $billno=$this->input->post('billno');
        ...
        {
            $result=$this->refundbillbrowser_model->search_labno($labno,$frmdate,$todate);
        ...
        if(!$this->input->post('labno') && $this->input->post('billno'))
        {
            $result=$this->refundbillbrowser_model->search_billno($billno,$frmdate,$todate);
            foreach ($result as $row) {
                echo "<tr class>";
                echo "<td>$row->patient</td>";
        ...
        if($this->input->post('labno') && $this->input->post('billno'))
        {
            $result=$this->refundbillbrowser_model->search_both($labno,$billno,$frmdate,$todate);
            foreach ($result as $row) {
                echo "<tr class>";
                echo "<td>$row->patient</td>";
        ...
        if(!$this->input->post('labno') && !$this->input->post('billno'))
        {
            $result=$this->refundbillbrowser_model->search($frmdate,$todate);
            foreach ($result as $row) {
                echo "<tr class>";
                echo "<td>$row->patient</td>";
